...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        refreshToken: json["refreshToken"],
        accessToken: json["accessToken"],
        refreshTokenCreated: json["refreshTokenCreated"] == null
            ? null
            : DateTime.parse(json["refreshTokenCreated"]),
        accessTokenCreated: json["accessTokenCreated"] == null
            ? null
            : DateTime.parse(json["accessTokenCreated"]),
