...
class GetbookingbyidResponse {
  ...
  factory GetbookingbyidResponse.fromRawJson(String str) =>
      GetbookingbyidResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetbookingbyidResponse.fromJson(Map<String, dynamic> json) =>
      GetbookingbyidResponse(
        success: json["success"],
        message: json["message"],
        data: json["data"] == null ? null : Data.fromJson(json["data"]),
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        bookingSnaks: json["bookingSnaks"] == null
            ? []
            : List<dynamic>.from(json["bookingSnaks"]!.map((x) => x)),
        payment:
  ...
  Map<String, dynamic> toJson() => {
        ...
        "hallChairs": hallChairs == null
            ? []
            : List<dynamic>.from(hallChairs!.map((x) => x.toJson())),
        "bookingSnaks": bookingSnaks == null
            ? []
            : List<dynamic>.from(bookingSnaks!.map((x) => x)),
        "payment": payment?.toJson(),
      };
}
...
class Movie {
  ...
  final DateTime? toDate;
  final DateTime? lastDateShowing;
  final double? rate; // ✅ تم تعديلها من int إلى double
  final String? trailerUrl;
  final int? durationInMinutes;
  ...
  factory Movie.fromJson(Map<String, dynamic> json) => Movie(
        ...
        rate: json["rate"]?.toDouble(), // ✅ تحويل من int إلى double
        trailerUrl: json["trailerUrl"],
        durationInMinutes: json["durationInMinutes"],
      );
