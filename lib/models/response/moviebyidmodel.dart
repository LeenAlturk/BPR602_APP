...
//     factory MovieResponseId.fromRawJson(String str) => MovieResponseId.fromJson(json.decode(str));

//     String toRawJson() => json.encode(toJson());

//     factory MovieResponseId.fromJson(Map<String, dynamic> json) => MovieResponseId(
