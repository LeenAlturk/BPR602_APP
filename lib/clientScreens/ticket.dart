  ...
  child: Text(
    ...
    overflow: TextOverflow.ellipsis,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "${cubit.getbookingbyidResponse!.data!.hallChairs!.map((e) => e.code).join(', ')}",
                                  style: TextStyle(
                                    fontSize: 16.sp,
                                    color: Colors.black,
                                  ),
                              ...
                              Column(
                                ...
                                children: [
                                  TicketDetailRow(
                                      label: "Booking ID",
                                      value:
                                          "${cubit.getbookingbyidResponse!.data!.id}"),
                                  SizedBox(
