...
// import 'package:bpr602_cinema/Animation/fadeinfadeoutt.dart';
...
//                                           .getProfileModel!.data!.image?.url !=
//                                       null)
//                                   ? NetworkImage(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: () {
              ...
              // 👇 في حالة تسجيل الخروج أو أي حالة أخرى: لا نعرض أي شيء حتى الانتقال
