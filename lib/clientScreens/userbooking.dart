...
class UserBooking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocListener<UserbookingCubit, UserbookingState>(
        listener: (context, state) {
          if (state is BookingdatakeRROR && !navigated) {
            navigated = true;
        ...
        child: BlocBuilder<UserbookingCubit, UserbookingState>(
              ...
              body: Builder(
                builder: (_) {
                  if (state is Bookinguserloading &&
                      cubit.userbooking.isEmpty) {
                    return const Center(child: CircularProgressIndicator());
                  }

                  if (state is BookingdataAccept &&
                      cubit.userbooking.isEmpty) {
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Text(
                                                'Hall : ${booking.movieTime!.hall!.name}',
                                                style: TextStyle(
                                                    color: Ktext,
                                                    fontSize: 12.sp,
                                                    fontWeight:
