...
//             AppConstants.showToast(context, "Delete Booking Done" , icon: Icons.done , iconcolor: Colors.green);
...
//               centerTitle: true,
//               backgroundColor: Kbackground,
//               title: Text('My Booking', style: TextStyle(color: Ktext)),
//               actions: [
//                 Padding(
...
//                   return  Center(child: Text("yOu dont Have any Booking yet"));
//                 }
...
//                                                     "Confirm Deletion" , style: TextStyle(color: Ktext),),
//                                                 content: const Text(
//                                                     "Are you sure you want to delete this booking?" , style: TextStyle(color: Colors.white)),
//                                                 actions: [
//                                                   TextButton(
//                                                     onPressed: () =>
//                                                         Navigator.pop(ctx),
...
//                               );
//                             } else {
//                               // تحميل الصفحة التالية عند الوصول للنهاية
//                               cubit.getbookings();
      ...
      children:  [
        ...
        Center(
          child: Column(
            ...
            children: [
              Icon(Icons.event_busy, color: Colors.white70, size: 80),
              SizedBox(height: 16),
              Text(
                    ...
                    children: [
                      Expanded(
                        child: ListView.builder(
                          physics: const AlwaysScrollableScrollPhysics(),
                          itemCount:
                              cubit.userbooking.length + (cubit.hasMore ? 1 : 0),
                          itemBuilder: (context, index) {
                            if (index < cubit.userbooking.length) {
                              final booking = cubit.userbooking[index];
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                              ' ${booking.movieTime!.hall!.name}',
                                              style: TextStyle(color: Whitconst)),
                                        ],
                                      ),
                                      Row(
                                        children: [
